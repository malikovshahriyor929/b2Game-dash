...
const adminAccess = ["dashboard", "simulators", "cashier", "bookings", "customers", "tariffs", "games", "logs", "support"];
const superAdminAccess = ["dashboard", "simulators", "cashier", "bookings", "customers", "tariffs", "games", "logs", "promo", "reports", "analytics", "support", "settings"];
